...
if (options.filter_len1 is None or
...
# training
filename_codetrfw = [ x for x in os.listdir(inDirTr) if 'codefw.npy' in x and 'RNA' in x ][0]
print("data for training " + filename_codetrfw)
rna_trfw = np.load(os.path.join(inDirTr, filename_codetrfw), allow_pickle=True)
rna_trbw = np.load(os.path.join(inDirTr, filename_codetrfw.replace('fw', 'bw')), allow_pickle=True)
# validation
filename_codevalfw = [ x for x in os.listdir(inDirVal) if 'codefw.npy' in x and 'RNA' in x ][0]
print("data for validation " + filename_codevalfw)
rna_valfw = np.load(os.path.join(inDirVal, filename_codevalfw), allow_pickle=True)
rna_valbw = np.load(os.path.join(inDirVal, filename_codevalfw.replace('fw', 'bw')),allow_pickle=True)


## loading DNA virus data
print("...loading DNA virus data...")
# training
filename_codetrfw = [ x for x in os.listdir(inDirTr) if 'codefw.npy' in x and 'DNA' in x ][0]
print("data for training " + filename_codetrfw)
dna_trfw = np.load(os.path.join(inDirTr, filename_codetrfw),allow_pickle=True)
dna_trbw = np.load(os.path.join(inDirTr, filename_codetrfw.replace('fw', 'bw')),allow_pickle=True)
# validation
filename_codevalfw = [ x for x in os.listdir(inDirVal) if 'codefw.npy' in x and 'DNA' in x ][0]
print("data for validation " + filename_codevalfw)
dna_valfw = np.load(os.path.join(inDirVal, filename_codevalfw),allow_pickle=True)
dna_valbw = np.load(os.path.join(inDirVal, filename_codevalfw.replace('fw', 'bw')),allow_pickle=True)
...
#print("The shape is " + str(X_trfw.shape))
...
modPattern = 'model_siamese_varlen_'+str(filter_len1)+'_fn'+str(nb_filter1)+'_dn'+str(nb_dense)
