...
del rna_trbw, dna_trbw, bac_trbw
...
### validation V+B
Y_val = np.concatenate((np.repeat(0, rna_valfw.shape[0]), np.repeat(1, dna_valfw.shape[0]), np.repeat(2, bac_valfw.shape[0])))
...
del rna_valbw, dna_valbw, bac_valbw
